...
if nargin<2
    opts.threshold.method = 'MarcenkoPastur';
    opts.Patterns.method = 'ICA';
    opts.Patterns.number_of_iterations = 5000;
end
...
switch opts.Patterns.method
    ...
    case 'ICA2'
        AssemblyTemplates=...
            fast_ica(SpikeCount,length(eigenvalues),opts.Patterns.number_of_iterations);
        prjs = AssemblyTemplates'*SpikeCount';
