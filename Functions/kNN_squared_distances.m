...
% matrix Q from samples (Y(:,t)) in matrix Y.
% The number of samples in Q (size(Q,2)) and Y (size(Y,2)) can be different.
% Parameters in the cost object (co), can be used to fine-tune the kNN search (k,...).
